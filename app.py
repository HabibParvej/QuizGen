...
<style>
    ...
    .leaderboard-table tr:hover td {
        ...
        background: rgba(0, 204, 255, 0.2);
        color: #00ffcc; /* Highlight text on hover */
    }
    ...
    if st.session_state.active_tab == 'generator':
        ...
        if st.session_state.quiz_data and st.session_state.quiz_type == "MCQ" and not st.session_state.show_results:
            ...
            with st.container():
                ...
                # Options
                if st.session_state.current_question not in st.session_state.user_answers:
                    ...
                    if user_answer:
                        st.session_state.user_answers[st.session_state.current_question] = user_answer[0]
